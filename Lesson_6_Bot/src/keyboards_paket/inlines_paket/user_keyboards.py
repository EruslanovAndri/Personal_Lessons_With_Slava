...
from keyboards_paket.inlines_paket.callback_data import navigation_items_callback,item_count_callback,basket_callback
...
basket_keyboard = InlineKeyboardButton(
    inline_keyboard=[
        [
